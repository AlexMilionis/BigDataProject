...
print('===========================')
df_zips = df.hint("shuffle_hash").join(zips.hint("shuffle_hash"), on=['LAT', 'LON'], how='inner')
...
df_zips_income = df_zips.hint("shuffle_hash").join(incomes.hint("shuffle_hash"), on=['Zip Code'], how='inner')
print('===========================')
